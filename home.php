        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link active" style="margin-left:10px;" aria-current="page" href="#">Home</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link  active" style="margin-left:10px;" href="#">Link</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link  active" style="margin-left: 10px;">Disabled</a>
                    </li>
                </ul>
                <form class="d-flex">
                    ...
                    <div class="btn-group">
                        <button class=" boxx"
                            style="border-radius: 10px; border: 0px; background-color: rgb(206, 206, 206); padding: 10px; margin-left: 5px;"
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" style="width: 300px;height: 300px;">
                            <a 
                                style="text-decoration: none;font-size: 11px; color: rgb(179, 179, 179); margin-left: 5px;">NOTIFICATIONS</a>
                            <button type="button" class="btn btn-link"
                                style="font-size: 12px; font-weight: 500; color: rgb(0, 85, 255);margin-left: 145px;"><span>See
                                    All</span></button>
                            <li>
                    ...
                    <div class="dropdown">
                        <button class=" " type="button"style="border-radius: 10px; border: 0px; margin-left: 5px;padding: 0px;"
                                ...
                                <div class="icon_C" style="text-align: center;">
                                    <button style="border: 0px;">
                                        <svg width="24" height="24" viewBox="0 0 24 24">
                                            <path fill="#5c6178" fill-rule="evenodd" stroke="none" stroke-width="1"
                                                id="Icon/small/plus"
                        ...
                        <div class="commit-text mt-5">
                            ...
                            padding: 20px; background-color: rgb(240, 240, 240);">
                                ...
                                <input type="text" style="margin-top: 15px;" class="form-control"
                                    placeholder="select a group..." aria-label="search" aria-describedby="basic-addon1">
                            ...
                            <div class="dropdown" style="float:right; border:0px;">
                                ...
                                <ul class="dropdown-menu" style="width: 200px;height: 150px;"
                                    ...
                                    <div class="button-2"> <span
                                            style="font-size: 14px; color: rgb(165, 165, 165);">AUTHOR</span>
                            ...
                            <div class="upcom01">
                                <div class="tilige " style="background-color: rgb(240, 240, 240);  border-radius: 5px">
                                    <div class="add-button d-flex"
                                        style="border-bottom: 1px solid rgb(190, 190, 190);padding: 10px;">
                                        <p style="margin: 0px;">Upcoming</p>
                                        <button
                                            style="border: 0px; background-color: rgb(240, 240, 240); margin-left: 140px;">
                                            <svg width="24" height="24" viewBox="0 0 24 24">
                                                <path fill="#5c6178" fill-rule="evenodd" stroke="none" stroke-width="1"
                                                    id="Icon/small/plus"
                                                    d="M13 11h4a1 1 0 010 2h-4v4a1 1 0 01-2 0v-4H7a1 1 0 010-2h4V7a1 1 0 012 0v4z">
                                            ...
                                            <div class="icon-wrapper d-flex">
                                                <div class="icon">
                                                    <i class="bi bi-emoji-laughing"
                                                        style="color: rgb(129, 129, 129);"></i>
                                                </div>
                                                <div class="tip"
                                                    style="font-size: 15px; color: rgb(177, 177, 177); padding-left: 5px;">
