        ...
        <div class="page-content container ">
            ...
            <form action="process-sigup.php" method="post">
                ...
                <div class="signup-or-container">
                    ...
                    <div class="mt-3">
                        <div class="position-relative form-group"><input name="email" id="email"
                                placeholder="Email Address" type="email"
                                class="qa-test-login-username form-control-lg form-control" value=""></div>
                    </div>
                    <div class="mt-3">
                        <div class="position-relative form-group"><input name="password" placeholder="Password*"
                                id="password" type="password"
                                class="qa-test-login-password form-control-lg form-control" value=""></div>
                    </div>
                    <div class="mt-3">
                        <div class="position-relative form-group"><input name="cpassword"
                                placeholder="Confirm Password*" id="cpassword" type="password"
                                class="qa-test-login-password form-control-lg form-control" value=""></div>
                    ...
                    <div class="mt-3">
                        <div class="signup-or-container">
                            ...
                            <input type="submit" name="btnSigup" value="Create your account"
                                class="btn btn-primary btn-lg btn-block ">
                            </input>
                    </div>
            </form>
            <div class="mt-2">
                <p style="text-align: center; margin: top 16px; font-size: 15px">Already have an account?
                    <a href="">Log in</a>
                </p><a href=""></a>
            </div>
            <div class="mt-3">
                <p>By signing up, you agree to our Terms of Service and Privacy Policy. Edmodo is ultimately owned and
                    controlled by NetDragon Websoft Holdings Limited, a public company principally based in Hong Kong
                    with operations in China, traded on the Hong Kong Stock Exchange (HKSE: 777), and ultimately
                    majority owned by Chinese persons located in China.</p>
            </div>
        </div>
    </div>
