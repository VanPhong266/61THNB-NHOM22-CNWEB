    ...
    <div id="main">
        ...
        <div style="margin-left: 88px; margin-right: 88px;" id="content">
            <div class="main_about row">
                <div class="col-md-6">
                    <img src="assets/img/Student-1.png" alt="" class="img-fluid rounded">
                </div>
                <div style="margin-top: 100px; margin-bottom: 100px;" class="col-md-6">
                    <h1 style="color: rgb(8, 8, 94);">Your best work
                        starts here</h1>
                    <p>Stay updated. Stay organized. See yourself grow.</p>
                    <button style="background-color: #ffc107; text-decoration:none;"><a href="signup.php">Create a Student Account</a></button>
                </div>
            </div>
            <hr>
            <div class="main_about row">
                <div style="margin-top: 100px; margin-bottom: 100px;" class="col-md-6">
                    <h1 style="color: rgb(8, 8, 94);">Stay on track</h1>
                    <p>There’s always a lot going on at school. Edmodo organizes your work with class folders and a built-in Planner, so that you can stress less.</p>
                    <a style="color: #fd7e14;" href="getting-started.php">Get started for free</a>
                </div>
                <div class="col-md-6">
                    <img src="assets/img/Student-2.png" alt="" class="img-fluid rounded">
                </div>
            </div>
            <hr>
            <div class="main_about row">
                <div class="col-md-6">
                    <img src="assets/img/Student-3.png" alt="" class="img-fluid rounded">
                </div>
                <div style="margin-top: 100px; margin-bottom: 100px;" class="col-md-6">
                    <h1 style="color: rgb(8, 8, 94);">Get the answers you need</h1>
                    <p>Hate it when class ends and you still have questions? With Edmodo, it’s easy to message your teacher or get help from your classmates.
                    </p>
                    <a style="color: #fd7e14;" href="getting-started.php">Get started for free</a>
                </div>
            </div>
            ...
            <div class="main_about row">
                <div style="margin-top: 100px; margin-bottom: 100px;" class="col-md-6">
                    <h1 style="color: rgb(8, 8, 94);">Discover your next passion</h1>
                    <p>Your next fixation is around the corner. With mindfulness activities, games, and more on Discover, you can find your next favorite topic on Edmodo.</p>
                    <a style="color: #fd7e14;" href="getting-started.php">Get started for free</a>
                </div>
                <div class="col-md-6">
                    <img src="assets/img/Student-4.png" alt="" class="img-fluid rounded">
                </div>
            </div>
        </div>
