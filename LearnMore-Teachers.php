    ...
    <div id="main">
        ...
        <div style="margin-left: 88px; margin-right: 88px;" id="content">
            <div class="main_about row">
                <div class="col-md-6">
                    <img src="assets/img/Teacher-1.png" alt="" class="img-fluid rounded">
                </div>
                <div style="margin-top: 100px; margin-bottom: 100px;" class="col-md-6">
                    <h1 style="color: rgb(8, 8, 94);">All your tools in one place</h1>
                    <p>Simplify communication and improve student engagement in your classroom and beyond.</p>
                    <button style="background-color: #ffc107; text-decoration:none;"><a href="signup.php">Create a Teacher Account</a></button>
                </div>
            </div>
            <hr>
            <div class="main_about row">
                <div style="margin-top: 100px; margin-bottom: 100px;" class="col-md-6">
                    <h1 style="color: rgb(8, 8, 94);">Conversations that change lives</h1>
                ...
                <div class="col-md-6">
                    <img src="assets/img/Teacher-2.png" alt="" class="img-fluid rounded">
                </div>
            </div>
            <hr>
            <div class="main_about row">
                <div class="col-md-6">
                    <img src="assets/img/Teacher-3.png" alt="" class="img-fluid rounded">
                </div>
                <div style="margin-top: 100px; margin-bottom: 100px;" class="col-md-6">
                    <h1 style="color: rgb(8, 8, 94);">Lessons for 21st-century students</h1>
                    <p>It feels like magic when a lesson captivates students and improves their understanding. With Edmodo, it’s easy to share digital assignments, create quizzes, or bring your favorite tools onboard.
                    </p>
                    <a style="color: #fd7e14;" href="getting-started.php">Get started for free</a>
                </div>
            </div>
            ...
            <div class="main_about row">
                <div style="margin-top: 100px; margin-bottom: 100px;" class="col-md-6">
                    <h1 style="color: rgb(8, 8, 94);">Resources by teachers, for teachers</h1>
                ...
                <div class="col-md-6">
                    <img src="assets/img/Teacher-4.png" alt="" class="img-fluid rounded">
                </div>
            </div>
        </div>
