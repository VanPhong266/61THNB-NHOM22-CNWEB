                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-current="navbarDropdown">
                                <li><a class="dropdown-item 1" href="LearnMore-Teacher.html">Teachers</a></li>
                                <li><a class="dropdown-item 2" href="LearnMore-Students.html">Students</a></li>
                                <li><a class="dropdown-item 3" href="LearnMore-Parents.html">Parents</a></li>
                                <li><a class="dropdown-item 4" href="#">Schools, Districts & Organizations</a></li>
                                <li><a class="dropdown-item 5" href="#">Distance Learning Toolkit</a></li>
                            </ul>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="getting-started.html">Getting
                                Started</a>
                        </li>
                    </ul>
                </div>
